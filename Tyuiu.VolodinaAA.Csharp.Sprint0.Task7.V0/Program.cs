...
using Tyuiu.VolodinaAA.Csharp.Sprint0.Task7.V0.Lib;

namespace Tyuiu.VolodinaAA.Csharp.Sprint0.Task7.V0
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Значение элементов из массива №1");
            ...
            Console.WriteLine("Значение элементов из массива №2");
